...
Achievement.create!(user: User.last, badge_id: 3)
Achievement.create!(user: User.last, badge_id: 4)
Achievement.create!(user: User.last, badge_id: 5)
Achievement.create!(user: User.last, badge_id: 6)
Achievement.create!(user: User.last, badge_id: 7)
Achievement.create!(user: User.last, badge_id: 8)
Achievement.create!(user: User.last, badge_id: 9)
Achievement.create!(user: User.last, badge_id: 10)
Achievement.create!(user: User.last, badge_id: 11)
